...
## 🎬 프로젝트 소개
<br>
React를 이용하여 만든 간단한 가위바위보 게임입니다.<br>
게임 시작시, 사용자는 5번의 기회를 통해 컴퓨터와 대결을 할 수 있습니다. 5번의 기회에서 더 많이 이기는 사람이 최종 승자입니다.
🎮 배포 링크 : https://rock-scissorspaper-game.netlify.app/
<br>
<br>
